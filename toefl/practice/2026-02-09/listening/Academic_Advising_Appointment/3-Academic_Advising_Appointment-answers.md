# Answer Key - Academic Advising Appointment
...
**1. C** - To discuss changing her major from Business to Environmental Science
   - Student says: "I see from your email that you're thinking about changing your major from Business to Environmental Science"
   - Wrong: A (grades not discussed as poor), B (not about electives), D (internship discussed later, not main reason)

**2. B** - It might take much longer to graduate
   - Student explicitly states: "That's actually my biggest concern...I'm worried I might need an extra year or even more"
   - Wrong: A (she asks about competitiveness later), C (parents not mentioned), D (difficulty not her concern)

**3. A, C** - Chemistry 101 AND Environmental Studies elective
   - Advisor says: "you took Chemistry 101 and Biology 150. Those actually count toward the Environmental Science major"
   - Also mentions "that Environmental Studies course"
   - Wrong: B and D (Business courses won't transfer)

**4. C** - 33 credits
   - Advisor calculates: "the major requires 45 credit hours...You've already got...about 12 credits...So I'd need 33 more credits? Exactly."
   - Wrong: A (that's what she already has), B (one full semester), D (total major requirement)

**5. B** - They could help the student graduate on time
   - Advisor says: "If you took two classes this coming summer, you could potentially still graduate on time next May"
   - Wrong: A (not required), C (advisor says they're more expensive: "$1,200 each"), D (they are available)

**6. B** - Many employers prefer January start dates when new budgets begin
   - Advisor states: "Many positions actually prefer January start dates because that's when new budgets kick in"
   - Wrong: A (not mentioned), C (not discussed), D (there is an advantage)

**7. B** - Complete an application with GPA requirements and a statement of purpose
   - Advisor explains: "you need to formally apply...they mainly look at your GPA in science courses and a statement of purpose"
   - Also mentions needing a letter of recommendation
   - Wrong: A (application required), C (not mentioned), D (courses already count)

**8. C** - 70%
   - Advisor says: "They accept about 70% of applicants"
   - Wrong: A, B, D (incorrect percentages)

**9. B** - She's considering the professor for her letter of recommendation
   - This is in response to advisor saying "you'll also need one letter of recommendation from a faculty member"
   - Advisor confirms: "That would be ideal" for the letter
   - Wrong: A, C, D (context shows it's about the recommendation letter)

**10. B** - Declare her intent to change majors with the Registrar's Office
   - Advisor's final advice: "make sure to officially declare your intent to change majors with the Registrar's Office, even before you get accepted"
   - Purpose: "so you won't accidentally register for Business classes"
   - Wrong: A (wait until accepted), C (discussed but not required before acceptance), D (suggested but not required first step)
